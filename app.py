...
# TODO: recommend saving this and then pointing to it on your own server rather than hardcoding the Unsplash URL
...
def graph():
    if request.method == 'GET':
        ...
        if request.form['password'] != PASSPHRASE:
            ...
            # TODO: perhaps move this to a JSON file for code cleanliness sake. Or just get rid of it
            if 1 == 2: # debug:
